    ...
    <>
        ...
        <footer className="footer bg-black">
            <div className="container">
                <div className="overflow-x-hidden" data-aos="eflip-down" data-aos-delay="500">
                    <div className="footer-grid">
                        <div className="pt-12">
                            <h3 className="section-title text-white mb-0"><span className="position-relative circle-shape footer-shape">Le</span>
                                t’s work together</h3>
                            <div className="d-flex flex-wrap align-items-center mt-10">
                                <span className="text-xl fw-bold font-Syne text-white">Based in Germany |</span>
                                <div className="footer-social">
                                    <ul className="d-flex flex-wrap gap-x-4 align-items-center list-unstyled p-0 footer-social-links">
                                        <li><a href="#" className="text-white footer-social-link">
                                        ...
                                        <li><a href="#" className="text-white footer-social-link"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="d-flex flex-column justify-content-between service-contact-card-footer">
                            <h3 className="text-xl fw-bold font-Syne text-white">Looking for a hectic designer?</h3>
                            <div className="d-flex justify-content-between align-items-center">
                                <p className="text-2xl fw-bold font-Syne leading-none text-warning">hello@henry.com</p>
                                <a href="#" className="text-white animate-arrow-up">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.6667 28.3334L28.3334 11.6667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M11.6667 11.6667H28.3334V28.3334" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                        ...
                        <div className="d-flex flex-column justify-content-between service-contact-card-footer">
                            <h3 className="text-xl fw-bold font-Syne text-white">Want a more in-depth look at my history?</h3>
                            <div className="d-flex justify-content-between align-items-center">
                                <p className="text-2xl fw-bold font-Syne leading-none text-warning">+598 6879 9874</p>
                                <a href="#" className="text-white animate-arrow-up">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.6667 28.3334L28.3334 11.6667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M11.6667 11.6667H28.3334V28.3334" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="py-72">
                                <svg className="w-100" width="1281" height="77" viewBox="0 0 1281 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M95.28 67.88H77.28L142.8 0.199951H172.8V77H142.8V24.68L151.8 28.4L104.4 77H68.4L20.88 28.52L30 24.8V77H0V0.199951H30L95.28 67.88Z" fill="#FFE9D9"></path>
                                    <path d="M199.289 65.36V47.36H281.369V65.36H199.289ZM172.409 77L223.889 0.199951H257.249L309.209 77H276.209L231.689 8.23995H249.569L205.409 77H172.409Z" fill="#FFE9D9"></path>
                                    ...
                                    <path d="M510.679 39.2V32.48L579.919 77H535.279L476.479 36.2L530.719 0.199951H573.439L510.679 39.2ZM446.719 0.199951H476.719V77H446.719V0.199951Z" fill="#FFE9D9"></path>
                                    <path d="M635.328 26.72H719.808V49.52H635.328V26.72ZM716.448 0.199951H746.448V77H716.448V0.199951ZM609.648 0.199951H639.648V77H609.648V0.199951Z" fill="#FFE9D9"></path>
                                    <path d="M783.281 44.6V54.2H874.481V77H753.281V0.199951H874.241V23H783.281V32.6H857.681V44.6H783.281Z" fill="#FFE9D9"></path>
                                    <path d="M1000.4 53.48L989.239 59.84V0.199951H1019.24V77H989.239L898.879 24.68L910.039 18.2V77H880.039V0.199951H910.039L1000.4 53.48Z" fill="#FFE9D9"></path>
                                    ...
                                    <path d="M1280.96 0.199951L1232.36 57.44V77H1202.36V57.44L1153.76 0.199951H1189.16L1228.64 50H1206.44L1245.56 0.199951H1280.96Z" fill="#FFE9D9"></path>
                                </svg>
                            </div>
                        </div>
                    ...
                    <div className="pt-6 copyright">
                        <div className="row">
                            ...
                            <div className="col-12 col-sm-8 order-last order-sm-first">
                                <p className="text-white text-lg fw-normal font-sans leading-7">©2023 Mark Henry, All Rights Reserved
                                </p>
                            </div>
                            <div className="col-12 col-sm-4 order-first order-sm-last">
                                <div className="d-flex justify-content-end mb-2 mb-sm-0">
                                    <a id="scrollUp" className="d-flex flex-wrap align-items-center gap-2" href="#" aria-label="scroll up">
                                        <span className="text-white text-lg fw-normal font-sans leading-7 transition-all">
                            Back to Top</span>
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 19V5" stroke="#FFB646" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M19 12L12 5L5 12" stroke="#FFB646" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
